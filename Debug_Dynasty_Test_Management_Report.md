...
- Jira: For task management (Kanban board). -(https://github.com/PLP-Database-Design/wk-5-Superdon-777-1/blob/main/jira_task_tracking_tool.png)
...
--Risk Coverage Chart:(https://github.com/PLP-Database-Design/wk-5-Superdon-777-1/blob/main/risk_chart.jpg)
...
------------------------------------------------------------------------------------------------------------------------
Everyone handles their role pretty well. 
The tasks become really easy to work on and accomplish given everyone focusing on a specific area which improved productivity and getting work done in time.
Having to work in team allowed us to focus and have better results in all areas.
